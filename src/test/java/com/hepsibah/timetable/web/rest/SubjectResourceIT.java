...
import com.hepsibah.timetable.repository.SubjectRepository;
...
class SubjectResourceIT {
    ...
    private static final Integer DEFAULT_REQ_HRS = 1;
    private static final Integer UPDATED_REQ_HRS = 2;
    ...
    public static Subject createEntity(EntityManager em) {
        Subject subject = new Subject().name(DEFAULT_NAME).reqHrs(DEFAULT_REQ_HRS);
        return subject;
    }
    ...
    public static Subject createUpdatedEntity(EntityManager em) {
        Subject subject = new Subject().name(UPDATED_NAME).reqHrs(UPDATED_REQ_HRS);
        return subject;
    }
    ...
    void createSubject() throws Exception {
        ...
        assertThat(testSubject.getReqHrs()).isEqualTo(DEFAULT_REQ_HRS);
    }
    ...
    void getAllSubjects() throws Exception {
        ...
        restSubjectMockMvc
            ...
            .andExpect(jsonPath("$.[*].reqHrs").value(hasItem(DEFAULT_REQ_HRS)));
    }
    ...
    void getSubject() throws Exception {
        ...
        restSubjectMockMvc
            ...
            .andExpect(jsonPath("$.reqHrs").value(DEFAULT_REQ_HRS));
    }
    ...
    void putNewSubject() throws Exception {
        ...
        updatedSubject.name(UPDATED_NAME).reqHrs(UPDATED_REQ_HRS);
        ...
        assertThat(testSubject.getReqHrs()).isEqualTo(UPDATED_REQ_HRS);
    }
    ...
    void fullUpdateSubjectWithPatch() throws Exception {
        ...
        partialUpdatedSubject.name(UPDATED_NAME).reqHrs(UPDATED_REQ_HRS);
